...
struct DjinniItemList {
    ...
    static djinni::Handle<DjinniOptionalRecordHandle> fromCpp(std::optional<::textsort::ItemList> dc);
    static std::optional<::textsort::ItemList> toCpp(djinni::Handle<DjinniOptionalRecordHandle> dh);
};
